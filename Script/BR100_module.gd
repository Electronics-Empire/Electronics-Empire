...
func _ready():
	...
	self.interpreter.connect("add_signal", self, "logic_executed")
	self.interpreter.connect("sub_signal", self, "logic_executed")
	self.interpreter.connect("multiply_signal", self, "logic_executed")
	self.interpreter.connect("divide_signal", self, "logic_executed")
	self.interpreter.connect("compare_signal", self, "logic_executed")
	self.interpreter.connect("jump_signal", self, "jump")
	self.interpreter.connect("look_signal", self, "look")
